...
import { Package, Calendar, Clock, ChevronLeft, ChevronRight, Plus, Eye, Cog, Download, Ban, CheckCircle, Trash2 } from 'lucide-react';
                            ...
                            <Tr key={m.id}>
                                ...
                                <Td className="text-right">
                                    <div className="inline-flex gap-2 flex-wrap justify-end">
                                        <Button variant="outline" size="sm" onClick={() => navigate(`/admin/merchants/${m.id}`)} icon={Eye}>View</Button>
