            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <Card className="h-full shadow-sm border-slate-200">
                    <div className="p-6 border-b border-slate-100 flex justify-between items-center">
                        ...
                        <Link to="/admin/transactions" className="text-sm text-primary-600 hover:text-primary-700 font-medium flex items-center">
                ...
                <Card className="h-full shadow-sm border-slate-200">
                    <div className="p-6 border-b border-slate-100 flex justify-between items-center">
                        ...
                        <Link to="/admin/withdrawals" className="text-sm text-primary-600 hover:text-primary-700 font-medium flex items-center">
                            View all <ArrowRight size={14} className="ml-1" />
                        </Link>
                    </div>
                    <div>
