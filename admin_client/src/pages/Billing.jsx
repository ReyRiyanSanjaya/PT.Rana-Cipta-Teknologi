...
const Billing = () => {
    ...
    if (loading) return <div className="p-10 text-center">Loading billing info...</div>;
    if (!billing) return <div className="p-10 text-center">Failed to load billing info.</div>;
