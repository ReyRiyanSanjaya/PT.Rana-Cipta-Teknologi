...
const ParticleDot = ({ particle, mouseX, mouseY, scrollYProgress }) => {
    ...
    return (
        <motion.div
            className="absolute rounded-full bg-blue-300/30 dark:bg-blue-400/10"
            style={{
                width: particle.size,
            ...
            <div className="relative w-full h-full flex flex-col justify-center gap-4">
                <div className="space-y-3">
                    {layers.map((layer) => (
                        <div
                            key={layer.label}
                            className="rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 px-4 py-3"
                        >
                            ...
                            <p className="text-[11px] text-slate-500 dark:text-slate-300">{layer.detail}</p>
                        </div>
                    ))}
                </div>
        ...
        return (
            <div className="h-full grid grid-cols-1 gap-4 items-center">
                {items.map((item) => (
                    <div
                        key={item.text}
                        className="rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 px-4 py-3 flex items-center justify-between"
                    >
                        <span className="text-sm text-slate-700 dark:text-slate-200">{item.text}</span>
                        <span className="ml-4 inline-flex items-center justify-center px-3 py-1 rounded-full text-xs font-semibold bg-blue-50 dark:bg-blue-500/10 text-blue-700 dark:text-blue-300 border border-blue-100 dark:border-blue-500/20">
                            Impact
                        </span>
                    </div>
                ))}
...
const FeatureCard = ({ icon: Icon, title, description, benefits, color, delay = 0 }) => {
    ...
    return (
        <motion.div
            ...
            viewport={{ once: true }}
            className="group relative bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-3xl p-8 shadow-sm hover:shadow-lg hover:border-blue-300 dark:hover:border-blue-500/50 transition-all duration-500 cursor-pointer"
            style={{
        ...
        >
            <motion.div
                className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-green-500/5 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
            ...
            <div className="relative z-10 pb-20 lg:pb-28">
                ...
                <motion.h3 
                    className="text-2xl font-bold text-slate-900 dark:text-white mb-4 group-hover:text-blue-600 dark:group-hover:text-blue-300 transition-colors duration-300"
                    style={{ transform: 'translateZ(30px)' }}
                >
                    {title}
                </motion.h3>
                
                <p className="text-slate-500 dark:text-slate-400 leading-relaxed mb-6 group-hover:text-slate-700 dark:group-hover:text-slate-200 transition-colors duration-300">
                    {description}
                </p>
                ...
                <div className="space-y-3">
                    {benefits.map((benefit, index) => (
                        ...
                        >
                            <motion.div 
                                className="w-2 h-2 rounded-full bg-gradient-to-r from-blue-500 to-green-500 group-hover/benefit:scale-125 transition-transform duration-300"
                            />
                            <span className="text-slate-500 dark:text-slate-400 text-sm group-hover/benefit:text-slate-700 dark:group-hover/benefit:text-slate-200 transition-colors duration-300">
                                {benefit}
                            </span>
                        </motion.div>
                    ))}
...
const StatCard = ({ value, label, icon: Icon, color, delay = 0 }) => (
    <motion.div
        ...
        transition={{ duration: 0.6, delay }}
        viewport={{ once: true }}
        className="relative overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-sm hover:shadow-lg transition-shadow"
    >
        <motion.div
            className="absolute inset-0 bg-gradient-to-r from-blue-500/0 via-blue-500/5 to-green-500/0"
            initial={{ opacity: 0 }}
            whileHover={{ opacity: 1 }}
            transition={{ duration: 0.4 }}
        />
        <div className="relative p-6 flex flex-col items-center text-center gap-3">
            <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${color} flex items-center justify-center mb-1 shadow-sm`}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
            {techs.map((tech, i) => (
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="flex flex-col items-center text-center p-4 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-lg hover:border-blue-300 dark:hover:border-blue-500/50 transition-all"
                >
                    <div className="w-12 h-12 rounded-xl bg-blue-50 dark:bg-blue-500/10 flex items-center justify-center mb-3">
                        <tech.icon size={28} className="text-blue-600 dark:text-blue-400" />
                    </div>
...
const Features = () => {
    ...
    return (
        <div ref={containerRef} className="min-h-screen bg-white dark:bg-slate-950 text-slate-800 dark:text-slate-200 font-sans selection:bg-blue-200 selection:text-blue-900 overflow-x-hidden relative transition-colors duration-300">
            <Navbar />

            <motion.div
                className="fixed top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-blue-600 to-green-500 origin-left z-40"
            ...
            <div className="fixed inset-x-0 bottom-0 z-30 hidden lg:flex justify-center pointer-events-none px-4 pb-6">
                <div className="pointer-events-auto max-w-xl w-full">
                    <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-xl shadow-blue-900/10 px-4 py-3 md:px-6 md:py-4 flex flex-col md:flex-row items-center gap-3">
                        <div className="flex-1 text-left">
                            <div className="text-xs uppercase tracking-[0.18em] text-blue-600 dark:text-blue-300 mb-1">
                        ...
                        <Link
                            to="/contact"
                            className="inline-flex items-center justify-center px-4 py-2 rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 text-white text-sm font-semibold shadow-[0_10px_30px_rgba(31,95,191,0.3)] hover:-translate-y-0.5 transition-all whitespace-nowrap"
                        >
                            Konsultasi gratis
                        </Link>
                    </div>
            ...
            >
                <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)] gap-10 items-center">
                    <div className="text-center lg:text-left space-y-8">
                        <motion.div 
                            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-green-50 dark:bg-green-500/10 border border-green-100 dark:border-green-500/20 text-xs font-semibold tracking-[0.2em] uppercase text-green-700 dark:text-green-300"
                        ...
                        <motion.h1 
                            ...
                            className="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight leading-tight text-slate-900 dark:text-white"
                        >
                            Fitur kelas <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-green-500">enterprise</span> 
                            <br className="hidden md:block" />
                            untuk skala <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-green-500">UMKM</span>.
                        </motion.h1>
                        <motion.p 
                            style={{ x: smoothMouse.x, y: smoothMouse.y }}
                            className="text-base md:text-lg text-slate-500 dark:text-slate-400 max-w-2xl mx-auto lg:mx-0 leading-relaxed"
                        >
                            Dari kasir hingga laporan keuangan, <span className="text-blue-600 dark:text-blue-300 font-semibold">RanaPOS</span> menyatukan semua data operasional
                        ...
                        >
                            <Link
                                to="/register"
                                className="inline-flex items-center justify-center px-6 py-3 rounded-2xl bg-gradient-to-r from-blue-600 to-blue-700 text-sm md:text-base font-semibold text-white shadow-[0_10px_30px_rgba(31,95,191,0.3)] hover:shadow-[0_15px_40px_rgba(31,95,191,0.45)] transition-all duration-300 hover:-translate-y-0.5"
                            >
                                Mulai free trial
                            ...
                            <Link
                                to="/contact"
                                className="inline-flex items-center justify-center px-6 py-3 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-sm md:text-base font-semibold text-slate-700 dark:text-slate-200 hover:border-blue-300 hover:text-blue-700 dark:hover:text-blue-400 transition-all duration-300"
                            >
                        ...
                        <motion.div
                            ...
                            className="flex flex-wrap items-center gap-4 justify-center lg:justify-start text-xs md:text-sm text-slate-500 dark:text-slate-400"
                        >
                            ...
                            <div className="flex items-center gap-2">
                                <div className="w-6 h-6 rounded-full bg-blue-100 dark:bg-blue-500/20 flex items-center justify-center">
                                    <Shield size={14} className="text-blue-600 dark:text-blue-300" />
                                </div>
                    ...
                    <motion.div 
                        ...
                        className="w-full"
                    >
                        <div className="relative rounded-3xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-2xl shadow-blue-900/10 p-4 md:p-5">
                            <div className="flex items-center justify-between mb-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    <div className="text-xs text-slate-500 dark:text-slate-300">RanaPOS Feature Console</div>
                                </div>
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-4">
                                <div className="rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 p-3">
                                    <div className="flex items-center justify-between mb-2">
                                        <span className="text-[11px] text-slate-500 dark:text-slate-400">POS Today</span>
                                        <span className="text-[11px] text-green-600 dark:text-green-400 font-medium">+18%</span>
                                    </div>
                                    <div className="text-lg font-semibold text-slate-900 dark:text-slate-50">Rp 24,5jt</div>
                                ...
                                <div className="rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 p-3 flex flex-col justify-between">
                                    <div className="flex items-center justify-between mb-2">
                                        <span className="text-[11px] text-slate-500 dark:text-slate-400">Inventory Health</span>
                                        <span className="text-[11px] text-blue-600 dark:text-blue-300">Stable</span>
                                    </div>
                                    <div className="flex items-end gap-1 h-10 mt-1">
                                        {[60, 90, 50, 80, 70].map((v, i) => (
                                            <div
                                                key={i}
                                                className="flex-1 rounded-full bg-slate-200 dark:bg-slate-800 overflow-hidden"
                                            >
                                                <div
                                                    className="w-full bg-gradient-to-t from-blue-600 to-green-500"
                                                    style={{ height: `${v}%` }}
                                                />
                                            </div>
                                        ))}
                            ...
                            <div className="rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 p-3 flex items-center justify-between">
                                <div>
                                    <div className="text-[11px] uppercase tracking-[0.16em] text-slate-400 dark:text-slate-500 mb-1">
                                        Flash Sales Engine
                                    </div>
                                    <div className="text-sm font-semibold text-slate-900 dark:text-slate-50">Happy Hour Kopi Susu</div>
                                    <div className="text-[11px] text-slate-500 dark:text-slate-400">Konversi +32% dibanding hari biasa</div>
                                </div>
                                <div className="flex flex-col items-end gap-1">
                                    <div className="px-2 py-1 rounded-full bg-green-50 dark:bg-green-500/15 border border-green-100 dark:border-green-400/40 text-[10px] text-green-700 dark:text-green-300 font-medium">
                                        LIVE
                                    </div>
                                    <div className="flex items-center gap-1 text-[10px] text-slate-400">
                                        <Users size={12} className="text-blue-500 dark:text-blue-300" />
            ...
            <div className="relative z-10">
                <div className="hidden 2xl:flex fixed right-6 top-1/2 -translate-y-1/2 z-40">
                    <div className="bg-white/90 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-700 rounded-2xl px-3 py-4 backdrop-blur-xl shadow-xl shadow-blue-900/10 flex flex-col gap-3">
                        {sectionNav.map((section) => (
                            ...
                            >
                                <div className="w-1.5 h-10 rounded-full bg-slate-200 dark:bg-white/10 overflow-hidden">
                                    <motion.div
                                        className="w-full h-full bg-gradient-to-b from-blue-600 to-green-500"
                                        animate={{
                                ...
                                <div className="text-left">
                                    <div className="text-[10px] uppercase tracking-[0.22em] text-slate-400 dark:text-slate-500">
                                        {section.short}
                                    </div>
                                    <div
                ...
                <section id="key-numbers" className="py-20 md:py-24 px-4 md:px-8">
                    <div className="max-w-6xl mx-auto space-y-10">
                        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
                            <div>
                                <div className="text-xs font-semibold tracking-[0.25em] uppercase text-blue-600 dark:text-blue-300 mb-2">
                                    Key numbers
                                </div>
                ...
                <section id="why-rana" className="py-24 px-4 md:px-8 bg-slate-50 dark:bg-slate-900 border-y border-slate-100 dark:border-slate-800">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-4">
                                <div className="flex gap-3 items-start">
                                    <div className="mt-1 w-6 h-6 rounded-full bg-blue-100 dark:bg-blue-500/20 flex items-center justify-center text-blue-600 dark:text-blue-300">
                                        <CheckCircle size={14} />
                                    </div>
                                    <div>
                                        <div className="font-semibold text-slate-900 dark:text-white">Fokus UMKM Indonesia</div>
                                        <div className="text-slate-500 dark:text-slate-400 text-sm">Didesain sesuai pola operasional toko, restoran, dan gerai ritel di Indonesia.</div>
                                    </div>
                                </div>
                                <div className="flex gap-3 items-start">
                                    <div className="mt-1 w-6 h-6 rounded-full bg-green-100 dark:bg-green-500/20 flex items-center justify-center text-green-600 dark:text-green-300">
                                        <Zap size={14} />
                                    </div>
                                    <div>
                                        <div className="font-semibold text-slate-900 dark:text-white">Siap offline dan online</div>
                                        <div className="text-slate-500 dark:text-slate-400 text-sm">Tetap bisa berjualan saat internet putus dengan sinkronisasi otomatis ketika tersambung kembali.</div>
                                    </div>
                                </div>
                                <div className="flex gap-3 items-start">
                                    <div className="mt-1 w-6 h-6 rounded-full bg-blue-100 dark:bg-blue-500/20 flex items-center justify-center text-blue-600 dark:text-blue-300">
                                    ...
                                    <div>
                                        <div className="font-semibold text-slate-900 dark:text-white">Insight keuangan yang bisa langsung dipakai</div>
                                        <div className="text-slate-500 dark:text-slate-400 text-sm">Laporan profit & loss, stok, dan performa cabang dalam format yang mudah dipahami pemilik bisnis.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="space-y-6">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-500/10 border border-blue-100 dark:border-blue-500/20 text-[11px] font-semibold uppercase tracking-[0.18em] text-blue-700 dark:text-blue-300">
                                <span className="w-2 h-2 rounded-full bg-green-500" />
                                <span>Use case utama</span>
                            </div>
                            <h3 className="text-2xl font-bold text-slate-900 dark:text-white">Cocok untuk jenis usaha seperti</h3>
                            <div className="grid grid-cols-2 gap-4">
                                {[
                                    ...
                                    <div
                                        key={label}
                                        className="flex items-center gap-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 hover:border-blue-300 dark:hover:border-blue-500/50 hover:shadow-sm transition-all duration-300"
                                    >
                                        <div className="w-8 h-8 rounded-full bg-blue-50 dark:bg-blue-500/10 flex items-center justify-center text-blue-600 dark:text-blue-400 text-xs font-semibold">
                                            <Users size={16} />
                                        </div>
                ...
                <section id="daily-flow" className="py-24 px-4 md:px-8">
                    <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                        <div className="space-y-6">
                            <div>
                                <div className="text-xs font-semibold tracking-[0.22em] uppercase text-blue-600 dark:text-blue-300 mb-2">
                                    Daily flow
                                </div>
                                <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight">
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    <motion.div
                                        ...
                                        viewport={{ once: true }}
                                        className="flex gap-4 p-4 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-blue-300 dark:hover:border-blue-500/50 hover:shadow-sm transition-all duration-300"
                                    >
                                        <div className="w-10 h-10 rounded-xl bg-blue-50 dark:bg-blue-500/10 flex items-center justify-center text-blue-600 dark:text-blue-400">
                                            <item.icon size={20} />
                                        </div>
                                        <div>
                                            <div className="text-[11px] uppercase tracking-[0.18em] text-slate-400 dark:text-slate-400 mb-1">
                                                {item.label}
                                            </div>
                            ...
                            <div className="space-y-4">
                                <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-5">
                                    <div className="flex items-center gap-3 mb-2">
                                        <div className="w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-700 flex items-center justify-center text-slate-600 dark:text-slate-200 text-xs font-semibold">
                                            01
                                        </div>
                                ...
                                <div className="rounded-2xl border border-blue-200 dark:border-blue-500/40 bg-gradient-to-br from-blue-50 to-green-50 dark:from-blue-500/10 dark:to-green-500/10 p-5 shadow-sm">
                                    <div className="flex items-center gap-3 mb-3">
                                        ...
                                        <div className="font-semibold text-slate-900 dark:text-white flex items-center gap-2">
                                            ...
                                            <Rocket size={16} className="text-blue-600 dark:text-blue-300" />
                                        </div>
                                    </div>
                ...
                <section id="all-features" className="py-24 px-4 md:px-8 bg-slate-50 dark:bg-slate-900 border-y border-slate-100 dark:border-slate-800">
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-16">
                            <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 dark:text-white mb-4 tracking-tight">Semua yang Anda Butuhkan</h2>
                            <p className="text-lg text-slate-500 dark:text-slate-400 max-w-2xl mx-auto">Dari kasir hingga laporan keuangan, kami menyediakan alat yang tepat untuk setiap aspek bisnis Anda.</p>
                        </div>
                ...
                <section id="ecosystem" className="py-24 px-4 md:px-8">
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-16">
                            <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 dark:text-white mb-4 tracking-tight">Visualisasi Ekosistem Fitur</h2>
                            <p className="text-lg text-slate-500 dark:text-slate-400 max-w-3xl mx-auto">Lihat bagaimana setiap fitur terhubung dan saling mendukung untuk menciptakan ekosistem bisnis yang kuat dan terintegrasi.</p>
                        </div>
                        <div className="h-[360px] md:h-[500px] w-full rounded-3xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-sm p-4">
                            <FeatureShowcase3D />
                        </div>
                    </div>
                </section>

                <section id="impact" className="py-24 px-4 md:px-8 bg-slate-50 dark:bg-slate-900 border-y border-slate-100 dark:border-slate-800">
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-16">
                            <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 dark:text-white mb-4 tracking-tight">Dampak Nyata bagi Bisnis Anda</h2>
                            <p className="text-lg text-slate-500 dark:text-slate-400 max-w-2xl mx-auto">RanaPOS bukan hanya software, tapi partner pertumbuhan yang memberikan hasil terukur.</p>
                        </div>
                ...
                <section id="implementation" className="py-24 px-4 md:px-8 bg-slate-50 dark:bg-slate-900 border-y border-slate-100 dark:border-slate-800">
                    <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="space-y-6">
                            <div className="rounded-3xl bg-gradient-to-br from-blue-600 to-blue-800 p-8 relative overflow-hidden shadow-xl shadow-blue-900/20">
                                <div className="absolute top-0 right-0 w-64 h-64 bg-green-400/20 rounded-full blur-3xl -mr-20 -mt-20" />
                                <div className="relative z-10">
                                    <div className="text-sm uppercase tracking-[0.2em] text-blue-200 mb-4">
                                        Langkah berikutnya
                                    </div>
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-4">
                                        <Link
                                            to="/contact"
                                            className="flex-1 inline-flex items-center justify-center px-6 py-3 rounded-2xl bg-white text-blue-700 font-semibold text-sm md:text-base hover:bg-blue-50 transition-colors"
                                        >
                                            Konsultasi dengan tim Rana
                                        </Link>
                                        <Link
                                            to="/register"
                                            className="flex-1 inline-flex items-center justify-center px-6 py-3 rounded-2xl border border-white/40 text-white font-semibold text-sm md:text-base bg-white/10 hover:bg-white/20 transition-colors"
                                        >
                ...
                <section id="faq" className="py-24 px-4 md:px-8">
                    <div className="max-w-5xl mx-auto">
                        <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 dark:text-white text-center mb-6 tracking-tight">
                        ...
                        <div className="space-y-4">
                            {faqItems.map((item, index) => (
                                <motion.button
                                    ...
                                    viewport={{ once: true }}
                                    className="w-full text-left bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl px-5 py-4 shadow-sm hover:border-blue-300 dark:hover:border-blue-500/50 hover:shadow-md transition-all duration-300"
                                >
                                    <div className="flex items-center justify-between gap-3">
                                        ...
                                        <motion.span
                                            ...
                                            className="flex items-center justify-center w-6 h-6 rounded-full bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-300"
                                        >
                                            <ArrowRight size={16} />
                                        </motion.span>
                                    </div>
                                    <AnimatePresence initial={false}>
                                        {openFaqIndex === index && (
                                            <motion.div
                                                ...
                                                transition={{ duration: 0.25 }}
                                                className="text-sm text-slate-500 dark:text-slate-300 border-t border-slate-100 dark:border-slate-700 pt-3"
                                            >
                                                {item.answer}
                                            </motion.div>
                                        )}
