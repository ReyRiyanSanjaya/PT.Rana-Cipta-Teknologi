                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                            color: ThemeConfig.brandColor.withValues(alpha: 0.10),
                            blurRadius: 24,
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    Text('Total Pembayaran',
                                        style: TextStyle(color: Colors.grey.shade500, fontSize: 11 * scale, fontWeight: FontWeight.w500)),
                                    const SizedBox(height: 2),
                                    Text(
                                      ThemeConfig.formatCurrency(cart.grandTotal),
                                      style: TextStyle(
                                        color: ThemeConfig.brandColor,
                                ...
                                SizedBox(
                                  ...
                                  child: ElevatedButton(
                                    onPressed: _isLoading ? null : () => _handleCheckout(context, cart, auth),
                                    ...
                                    child: Ink(
                                      decoration: BoxDecoration(
                                        ...
                                        boxShadow: _isLoading ? null : [
                                          BoxShadow(
                                            color: ThemeConfig.brandColor.withValues(alpha: 0.35),
                                            blurRadius: 12,
                                        ...
                                        child: _isLoading
                                            ...
                                            : Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text('Pesan!', style: TextStyle(fontWeight: FontWeight.w900, fontSize: 15 * scale, color: Colors.white)),
                                                ],
                                              ),
                                      ),
                                    ),
  ...
  Widget _buildStoreHeader(MarketCartProvider cart) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: ThemeConfig.brandColor.withValues(alpha: 0.15), width: 1.5),
        boxShadow: [
          BoxShadow(
            color: ThemeConfig.brandColor.withValues(alpha: 0.08),
            blurRadius: 20,
            offset: const Offset(0, 8))
        ],
      ),
          ...
          Row(
            children: [
              Container(
                ...
                child: const Icon(Icons.store_rounded, color: ThemeConfig.brandColor, size: 20),
              ),
      ...
      background: Container(
        ...
        child: const Column(
          ...
          children: [
            ...
            SizedBox(height: 4),
            Text('Hapus', style: TextStyle(color: Colors.red, fontSize: 11, fontWeight: FontWeight.w700)),
          ],
        ),
      ),
      onDismissed: (_) {
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Rp ${item.price.toInt()}',
                    style: const TextStyle(color: ThemeConfig.brandColor, fontWeight: FontWeight.w900, fontSize: 15),
                  ),
                ],
              ),
            ),
            ...
            Container(
              decoration: BoxDecoration(
                color: ThemeConfig.brandColor.withValues(alpha: 0.06),
                borderRadius: BorderRadius.circular(12),
                border: Border.all(color: ThemeConfig.brandColor.withValues(alpha: 0.2)),
              ),
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
  ...
  Widget _qtyBtn({required IconData icon, required VoidCallback onTap, bool filled = false}) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Icon(icon, size: 16, color: filled ? Colors.white : ThemeConfig.brandColor),
      ),
    );
  }
