...
class _MarketSearchScreenState extends State<MarketSearchScreen> {
      ...
      appBar: AppBar(
        ...
        title: TextField(
          ...
          decoration: InputDecoration(
            hintText: _isListening ? 'Mendengarkan...' : 'Cari produk, makanan...',
            border: InputBorder.none,
            hintStyle: TextStyle(
              color: _isListening ? ThemeConfig.brandColor : Colors.grey.shade400,
  ...
  Widget _buildEmptyState(double scale) {
    final trending = ['Sate Ayam', 'Kopi Susu', 'Nasi Goreng', 'Keripik Tempe', 'Batik'];
    
    // Show history and trending if query is empty
          ...
          return ListView(
            children: [
              if (history.history.isNotEmpty) ...[
                ...
                ...history.history.take(5).map((q) => ListTile(
                      leading: const Icon(Icons.history, color: Colors.grey),
                      title: Text(q, style: TextStyle(fontSize: 13 * scale)),
                      onTap: () {
                        _searchCtrl.text = q;
                        _doSearch();
                      },
                ...
                child: Wrap(
                  ...
                  children: trending.map((t) => GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Text(t, style: TextStyle(fontSize: 12 * scale, color: ThemeConfig.textSecondary)),
                    ),
                  )).toList(),
                ),
              ),
