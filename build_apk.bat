...
if exist "build\app\outputs\flutter-apk\app-release.apk" (
  copy "build\app\outputs\flutter-apk\app-release.apk" "builds\rana-merchant-release.apk"
) else (
...
if not exist builds mkdir builds
if exist "build\app\outputs\flutter-apk\app-release.apk" (
  copy "build\app\outputs\flutter-apk\app-release.apk" "builds\rana-market-release.apk"
) else (
