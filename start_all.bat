...
:: 4. Distributor Client
start "Rana Distributor Client" cmd /k "cd distributor_client && echo Starting Distributor Portal... && npm run dev"
...
echo  Distributor Portal: http://localhost:5175
echo ========================================================
echo.
pause
