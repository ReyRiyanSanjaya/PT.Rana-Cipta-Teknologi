    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _buildLocationRow(Icons.radio_button_checked_rounded, Colors.green, widget.request['origin'] ?? widget.request['originAddress'] ?? 'N/A'),
          const SizedBox(height: 12),
          _buildLocationRow(Icons.location_on_rounded, Colors.red, widget.request['destination'] ?? widget.request['destAddress'] ?? 'N/A'),
  ...
  Widget _buildHeader(bool isRide) {
    return Row(
      children: [
        ...
        Text('Rp${ThemeConfig.formatCurrency((widget.request['price'] as num).toDouble())}', 
