      ...
      return Scaffold(
        body: Center(
          child: SizedBox(
            height: 180,
            child:
                _safeLottie(AssetsConfig.lottieLoadingCreator, repeat: true) ??
            ...
            child: Center(
              child: ConstrainedBox(
                constraints: BoxConstraints(
                  maxWidth: isWide ? 1000 : constraints.maxWidth,
                ),
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          _isVideoMode ? 'Live Canvas' : 'Canvas',
                          style: GoogleFonts.poppins(
                        ...
                        Row(
                          children: [
                            IconButton(
                              ...
                              icon: Icon(
                                  _editMode ? Icons.check_circle : Icons.tune),
                    ...
                    if (_selectedTemplate == 'Discount' ||
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: ThemeConfig.brandColor),
                        ...
                        child: Column(
                          ...
                          children: [
                                    ...
                                    children: [
                                      Text(
                                          ...
                                          style: GoogleFonts.poppins(
                                              ...
                                              fontSize: 16 * ThemeConfig.tabletScale(context, mobile: 1.0),
                                              color: ThemeConfig.brandColor)),
                                      Text(
                            ...
                            if (_selectedProduct != null) ...[
                              const SizedBox(height: 8),
                              Text(
                                "Harga asli: ${NumberFormat.currency(locale: 'id_ID', symbol: '${MerchantConfig.defaultCurrencySymbol} ', decimalDigits: 0).format(_selectedProduct!['originalPrice'] ?? _selectedProduct!['sellingPrice'])} | Durasi: berlaku selama ${_durationController.text} hari",
                                style: GoogleFonts.poppins(
                    ...
                    CaptionComposer(
                      ...
                      onImprove: () async {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text('Sihir AI sedang bekerja...'))
                        );
                        
                        try {
                          final response = await ApiService().askMerchantAssistant(
                            "Tolong perbaiki dan buat caption promo ini jadi lebih menarik dan profesional: $txt"
                          );
                          final improved = response['answer']?.toString();
                          ...
                          if (mounted) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(content: Text('Gagal menghubungi asisten AI: $e'))
                            );
                          }
                        }
                      },
                    ...
                    if (_shareCountToday > 0)
                      Center(
                        child: Text(
                          "Poster dibuat hari ini: $_shareCountToday",
                          style: GoogleFonts.poppins(
          ...
          Row(
            children: [
              ElevatedButton.icon(
                  ...
                  icon: const Text('🎲'),
                  label: const Text('Acak caption')),
              const SizedBox(width: 8),
              OutlinedButton.icon(
                  onPressed: widget.onImprove,
                  icon: const Text('✨'),
                  label: const Text('Haluskan caption')),
              const Spacer(),
              Stack(
                alignment: Alignment.center,
                children: [
...
class MarketingCTA extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final label = isVideoMode ? 'Bagikan Video' : 'Bagikan Poster';
