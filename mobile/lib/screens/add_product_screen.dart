...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (mounted) ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Gagal: $msg'), backgroundColor: ThemeConfig.colorError));
    } catch (e) {
      if (mounted) ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Gagal: $e'), backgroundColor: ThemeConfig.colorError));
    } finally {
                  ...
                  children: [
                    ...
                    if (kIsWeb)
                      Padding(
                        ...
                        child: Text('Jika di web, gambar akan diupload sebagai base64.',
                            style: TextStyle(
                                fontSize: 12,
                                color: colorScheme.onSurface
                                    .withOpacity(0.6))),
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      ...
                      if (sku.isEmpty) {
                        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Isi SKU terlebih dahulu')));
                        return;
                      }
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => ProductBarcodeScreen(
                            sku: sku,
                ...
                children: [
                   Expanded(
                    child: TextFormField(
                      ...
                      decoration: const InputDecoration(labelText: 'Harga Modal (HPP)', border: OutlineInputBorder(), prefixText: '${MerchantConfig.defaultCurrencySymbol} '),
                      validator: (v) => v!.isEmpty ? 'Wajib diisi' : null,
                    ),
                  ),
                  ...
                  Expanded(
                    child: TextFormField(
                      ...
                      keyboardType: TextInputType.number,
                      decoration: const InputDecoration(labelText: 'Harga Jual', border: OutlineInputBorder(), prefixText: '${MerchantConfig.defaultCurrencySymbol} '),
                      validator: (v) => v!.isEmpty ? 'Wajib diisi' : null,
                    ),
                  ),
                ],
