...
const bannerStorage = multer.diskStorage({
    destination: (req, file, cb) => {
        const absoluteDir = path.join(__dirname, '../../uploads/banners');
...
router.get('/banners/admin', authenticateToken, checkRole(['SUPER_ADMIN']), controller.getAllBanners);
router.post('/banners/upload', authenticateToken, checkRole(['SUPER_ADMIN']), uploadBanner.single('file'), controller.uploadBannerImage);
router.post('/banners', authenticateToken, checkRole(['SUPER_ADMIN']), controller.createBanner);
router.put('/banners/:id', authenticateToken, checkRole(['SUPER_ADMIN']), controller.updateBanner); // [NEW]
router.delete('/banners/:id', authenticateToken, checkRole(['SUPER_ADMIN']), controller.deleteBanner);
