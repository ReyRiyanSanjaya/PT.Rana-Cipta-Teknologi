...
router.get('/stats/chart', adminController.getDashboardChart);
...
router.use('/community', require('./admin/community'));
...
router.get('/settings/subscription-banks', systemController.getSubscriptionBankAccounts);
router.post('/settings/subscription-banks', systemController.updateSubscriptionBankAccounts);
...
router.put('/admins/:id', adminController.updateAdminUser); // [NEW]
