...
const AggregationService = {
    ...
    async processDailyAggregates(tenantId, storeId, date) {
        logger.info(`[Aggregation] Processing for ${tenantId} - ${storeId} on ${date}`);
        ...
        await prisma.dailySalesSummary.upsert({
            ...
            update: {
                ...
                totalProfit: grossProfit || 0, // [FIXED] Populating profit
        ...
        logger.info(`[Aggregation] Updated DailySalesSummary: Profit ${grossProfit}`);
            ...
            if (existing) {
                await prisma.productSalesSummary.update({
                    ...
                    data: {
                        ...
                        // Schema: ProductSalesSummary { id, tenantId, productId, date, totalQuantity, totalRevenue }
                    }
                });
            } else {
